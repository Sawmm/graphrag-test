...
## Document metadata
- **HuggingFace ID:** axiong/PMC_LLaMA_13B
- **Source card file:** `raw/axiong__PMC_LLaMA_13B.md`
...
- **System name and version:** PMC_LLaMA_13B
- **Intended purpose / task:** To obtain the foundation model in medical field, we propose MedLLaMA_13B and PMC_LLaMA_13B. MedLLaMA_13B is initialized from LLaMA-13B and further pretrained with medical corpus. Despite the expert knowledge gained, it lacks instruction-following ability. Hereby we construct a instruction-tuning dataset and evaluate the tuned model.
...
MedLLaMA_13B is initialized from LLaMA-13B and further pretrained with medical corpus. Hereby we construct a instruction-tuning dataset and evaluate the tuned model.

### 2.2 Provenance  `Art. 10(2)(b)`
Further pretrained with medical corpus.
