...
async def extract_and_store(
    ...
    # ABLATION: GraphPruning step removed. Off-schema labels survive into the
    # cache; kg_to_rdf silently drops anything it doesn't recognise. The point
    # of this variant is to measure what pruning is actually worth.
    ...
    log.info("Extracted %d nodes, %d relationships (raw, no pruning)",
             len(raw_graph.nodes), len(raw_graph.relationships))

    graph_result  = raw_graph
